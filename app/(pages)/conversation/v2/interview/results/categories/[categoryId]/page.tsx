...
import { MetadataType, InterviewSessionType, SubCategoryType } from '@/app/(pages)/conversation/v2/ConversationModel/types';
...
const Page = () => {
  ...
  useEffect(() => {
    const fetchResults = async () => {
      ...
      try {
        setIsLoading(true);
        const uri = `/conversation/v2/interview/completed-by-categories/${categoryId}`;
            ...
            {subcategories.map((sub_category, index) => (
              <div key={index} className="mb-4">
                ...
                <p className="text-lg mb-2">
                  ...
                  <Link href={`/conversation/v2/interview/results/categories/${categoryId}/sub-category/${sub_category.id}`}>
