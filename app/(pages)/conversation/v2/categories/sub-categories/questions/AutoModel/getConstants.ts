...
const modelNameSingular = 'Questions';
const modelURI = 'conversation/v2/categories/sub-categories/questions';
const apiEndpoint = 'conversation/v2/categories/sub-categories/questions/';

// Define fillable fields for the Questions model
const fillableFields = [
  {
    ...
    isUnique: false,
    dropdownSource: "conversation/v2/categories",
...
// Create Questions constants using the createModelConstants function
