...
const modelID = '38bb5707-5d38-4a23-a363-29b4e80d2842';
const modelNameSingular = 'Stage';
const modelNamePlural = 'Stages';
const modelURI = '/stages';
const apiEndpoint = '/api/stages/';

// Define fillable fields for the Stage model
...
// Create Stage constants using the createModelConstants function
