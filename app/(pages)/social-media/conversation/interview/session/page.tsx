            ...
            <div ref={conversationsContainer} className="flex-1 overflow-auto px-2 my-3">
                ...
                }
                {
                    checkedQuestionsCount ? (
                        questionsCount === 0 ?
                            <p className="text-center my-3 text-lg"><span className="text-warning">No questions available.</span><br /> <Link href={`/social-media/conversation/categories/sub-categories/questions/?category_id=${selectedCategory.id}&sub_category_id=${selectedSubCategory.id}&model_action=create`} className="text-primary">Add questions</Link></p>
                            :
