...
const modelID = '7454f0a6-db92-48e5-ba85-720afddb7a9b';
const modelNameSingular = 'ProjectHistory';
const modelNamePlural = 'ProjectHistories';
const modelURI = 'ProjectHistory';
const apiEndpoint = 'ProjectHistory/';

// Define fillable fields for the ProjectHistory model
...
// Create ProjectHistory constants using the createModelConstants function
