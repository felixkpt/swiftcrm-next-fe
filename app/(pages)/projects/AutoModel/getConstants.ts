...
const modelID = 'f85fecc8-440e-4035-9dfe-606d21f155a4';
const modelNameSingular = 'Project';
const modelNamePlural = 'Projects';
const modelURI = '/projects';
const apiEndpoint = '/projects/';

// Define fillable fields for the Project model
...
// Create Project constants using the createModelConstants function
