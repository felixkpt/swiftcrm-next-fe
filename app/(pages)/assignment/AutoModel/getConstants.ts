...
const modelID = '7ef150e4-5cef-4fd0-8e87-20a7accf0148';
const modelNameSingular = 'Assignment';
const modelNamePlural = 'Assignments';
const modelURI = '/assignment';
const apiEndpoint = '/api/assignment/';

// Define fillable fields for the Assignment model
...
// Create Assignment constants using the createModelConstants function
