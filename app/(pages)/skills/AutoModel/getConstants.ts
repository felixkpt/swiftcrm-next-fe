...
const modelID = 'c1c9196e-6b57-459e-8d42-f5e2d16bc8aa';
const modelNameSingular = 'Skill';
const modelNamePlural = 'Skills';
const modelURI = '/skills';
const apiEndpoint = '/skills/';

// Define fillable fields for the Skill model
...
// Create Skill constants using the createModelConstants function
