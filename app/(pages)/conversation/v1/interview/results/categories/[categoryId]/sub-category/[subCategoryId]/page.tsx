...
import InterviewListCard from '@/app/(pages)/conversation/v1/interview/session/components/InterviewListCard';
import { MetadataType, ResultsType } from '@/app/(pages)/conversation/v1/ConversationModel/types';
