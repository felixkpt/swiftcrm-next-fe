import AutoRecordActionSection from '@/app/components/AutoTableModes/Default/AutoRecordActionSection';
import ModelType from '../../../AutoModel/types';
import { ActionListType } from '@/app/components/Autos/BaseAutoModel/types';
