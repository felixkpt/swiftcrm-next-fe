...
const modelNameSingular = 'action-labels';
...
// Define fillable fields for the action-labels model
...
// Create action-labels constants using the createModelConstants function
