...
import CategoryType from '@/app/(pages)/conversation/v2/categories/AutoModel/types';
...
export const useConversation = (
    ...
    const getInterviewSession = async () => {
        ...
        const uri = `/conversation/v2/interview/${selectedSubCategory.id}/progress?interview_id=${currentSessionId}`;
        try {
