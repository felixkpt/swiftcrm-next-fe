...
const modelID = 'e9b302ed-33f4-45ce-a273-6faa5197e37a';
const modelNameSingular = 'Novel';
const modelNamePlural = 'Novels';
const modelURI = '/novels';
const apiEndpoint = '/api/novels/';

// Define fillable fields for the Novel model
...
// Create Novel constants using the createModelConstants function
